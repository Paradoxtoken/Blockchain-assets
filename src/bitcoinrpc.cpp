...
{
    return GetBoolArg("-testnet", false) ? 29220 : 19220;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Paradox server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: paradox-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use paradoxd";
